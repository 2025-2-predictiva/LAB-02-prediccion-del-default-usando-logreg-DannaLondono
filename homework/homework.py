...
def crear_pipeline_rf(categorical_cols, numeric_cols) -> Pipeline:
    ...
    cat_preprocess = Pipeline(steps=[
        ...
        # usa sparse=False para compatibilidad amplia de scikit-learn
    ...
    model = Pipeline(steps=[
            ("prep", preprocessor),
            ("select", SelectKBest(score_func=f_classif, k=29)),
...
if __name__ == "__main__":
    ...
    param_dist = {
        ...
        "clf__solver": ["lbfgs", "liblinear"],  # Algoritmo de optimización
    }
